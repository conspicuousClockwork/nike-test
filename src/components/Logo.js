...
class Logo extends Component {
  render() {
    return (
      <svg className={css(styles.logo)} version="1.1" xmlnsSvg="http://www.w3.org/2000/svg" xmlns="&ns_svg;" xmlnsXlink="&ns_xlink;"  viewBox="135.5 361.375 200 72" overflow="visible" enableBackground="new 135.5 361.375 200 72" xmlSpace="preserve">
